...
public class PeerAdapter extends RecyclerView.Adapter<PeerAdapter.PeerViewHolder> {
    ...
    public PeerAdapter(@NonNull RoomStore store, @NonNull LifecycleOwner lifecycleOwner, @NonNull RoomClient roomClient) {
        mStore = store;
    ...
    public PeerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PeerViewHolder(view, new PeerProps(((AppCompatActivity) context).getApplication(), mStore));
    }
