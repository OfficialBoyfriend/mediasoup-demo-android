...
public class RoomActivity extends AppCompatActivity {
    ...
    private void loadRoomConfig() {
        ...
        // If not set, generate random values.
    ...
    private void initViewModel() {
        ...
        final Observer<Notify> notifyObserver = notify -> {
            ...
            if ("message".equals(notify.getType())) {
                Toast.makeText(this, notify.getTitle() + "\n" + notify.getText(), Toast.LENGTH_SHORT).show();
                return;
            }
        ...
        mBinding.chatInput.setOnKeyListener((v, keyCode, event) -> {
    ...
    private void checkPermission() {
        String[] permissions = {Manifest.permission.INTERNET, Manifest.permission.RECORD_AUDIO, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE};
