...
public class Protoo extends org.protoojs.droid.Peer {
    ...
    private Observable<String> request(String method, @NonNull JSONObject data) {
        ...
        return Observable.create(emitter -> request(method, data, new ClientRequestHandler() {
            @Override
    ...
    @WorkerThread
    public String syncRequest(String method, @NonNull RequestGenerator generator) throws ProtooException {
        JSONObject req = new JSONObject();
        generator.request(req);
