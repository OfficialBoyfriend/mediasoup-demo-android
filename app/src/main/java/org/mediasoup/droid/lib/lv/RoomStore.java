...
public class RoomStore {
    ...
    private final SupplierMutableLiveData<RoomInfo> roomInfo = new SupplierMutableLiveData<>(RoomInfo::new);

    // me
    // mediasoup-demo/app/lib/redux/reducers/me.js
    private final SupplierMutableLiveData<Me> me = new SupplierMutableLiveData<>(Me::new);

    // producers
    // mediasoup-demo/app/lib/redux/reducers/producers.js
    private final SupplierMutableLiveData<Producers> producers = new SupplierMutableLiveData<>(Producers::new);

    // peers
    // mediasoup-demo/app/lib/redux/reducers/peer.js
    private final SupplierMutableLiveData<Peers> peers = new SupplierMutableLiveData<>(Peers::new);

    // consumers
    // mediasoup-demo/app/lib/redux/reducers/consumers.js
    private final SupplierMutableLiveData<Consumers> consumers = new SupplierMutableLiveData<>(Consumers::new);

    // dataConsumers
    // mediasoup-demo/app/lib/redux/reducers/dataConsumers.js
    private final SupplierMutableLiveData<DataConsumers> dataConsumers = new SupplierMutableLiveData<>(DataConsumers::new);
